...
public class VibrationSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public VibrationSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.VibrationSeekBarPreference);
        ...
        Integer id = a.getResourceId(R.styleable.VibrationSeekBarPreference_units, 0);
        if (id > 0) {
            mUnits = context.getResources().getString(id);
        }
        id = a.getResourceId(R.styleable.VibrationSeekBarPreference_defaultText, 0);
        if (id > 0) {
