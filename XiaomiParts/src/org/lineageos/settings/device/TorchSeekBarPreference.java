...
public class TorchSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public TorchSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
                                  int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.TorchSeekBarPreference);
        ...
        Integer id = a.getResourceId(R.styleable.TorchSeekBarPreference_units, 0);
        if (id > 0) {
            mUnits = context.getResources().getString(id);
        }
        id = a.getResourceId(R.styleable.TorchSeekBarPreference_defaultText, 0);
        if (id > 0) {
    ...
    public TorchSeekBarPreference(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TorchSeekBarPreference(Context context) {
        this(context, null);
    }
